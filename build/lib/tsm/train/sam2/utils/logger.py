...
from tsm.train.sam2.utils.train_utils import get_machine_local_and_dist_rank, makedir
...
def setup_logging(
    ...
    console_handler = logger.StreamHandler(sys.stdout)
    ...
    if log_filename and rank == 0:
        file_handler = logger.StreamHandler(_cached_log_stream(log_filename))
